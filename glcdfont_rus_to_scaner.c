...
0x06, 0x09, 0x09, 0x06, 0x00, // 176 - символ градуса - tft.cp437(true); не пропускаем
...
0xFF, 0x01, 0x01, 0x01, 0x01 // 255 - FF - 0x48, 0x34, 0x14, 0x14, 0x7C
};
